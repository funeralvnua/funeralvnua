...
export async function generateMetadata({
  ...
  const description = isUk
    ? 'Цілодобова організація поховань у Вінниці та області. Виклик ритуального агента безкоштовно, без передоплат. Понад 25 років допомоги родинам — від документів до пам\'ятника.'
