...
export async function generateMetadata({
  ...
  const description = isUk
    ? 'Понад 25 років допомагаємо родинам Вінниці у скорботні дні. Ліцензії, досвід, повний цикл послуг — від агента до памʼятника.'
      ...
      <section className="bg-[--color-surface-alt] py-10 md:py-16">
        <div className="container-content">
          <div className="prose-mdx max-w-3xl">
            ...
            <p>
              {isUk
                ? 'Повний цикл ритуальних послуг — від виклику агента у перші години до встановлення памʼятника через рік.'
            ...
            <ul>
              {(isUk
                ? [
                    ...
                    'Виготовлення та встановлення памʼятників',
            ...
            <p>
              {isUk
                ? 'У ритуальній сфері довіра — найважливіше. Наша служба заслужила її роками сумлінної роботи. Ми не тиснемо, не навʼязуємо непотрібного, не додаємо прихованих платежів. Кожна родина отримує те, що замовила, і за фіксованою ціною.'
