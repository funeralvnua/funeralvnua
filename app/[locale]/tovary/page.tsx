...
const CATEGORIES: Category[] = [
  {
    ...
    description: {
      uk: 'Дерев\'яні труни різних класів — від базових до елітних. Стандартні розміри, оббивка тканиною.',
  ...
  },
  {
    ...
    description: {
      uk: 'Тимчасові дерев\'яні хрести для встановлення на могилі до встановлення пам\'ятника.',
      ru: 'Временные деревянные кресты для установки на могиле до установки памятника.',
    },
    priceFrom: 600,
    items: {
      uk: [
        'Простий дерев\'яний — від 600 ₴',
        'Лакований — від 1 000 ₴',
      ...
      <section className="container-content py-10 md:py-16">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          {CATEGORIES.map((cat) => (
            ...
            >
              <h2 className="font-heading text-2xl text-[--color-ink] md:text-3xl">
                {cat.title[loc]}
              </h2>
              <p className="mt-2 text-sm text-[--color-ink-soft]">{cat.description[loc]}</p>
